...
quant_path = "./qwen-14b-instruct-8bit-custom" # 내 손으로 압축한 8-bit 모델이 저장될 로컬 폴더!

print(f"🚀 [1단계] 거대한 원본 14B 모델({model_id})을 8-bit로 양자화하며 메모리로 불러옵니다...")
...
path_in_repo = "Qwen2.5-14B/14B-8Bit-Q" # 8-bit 양자화 모델 전용 폴더
...
api.upload_folder(
    ...
    commit_message="Upload 14B-8Bit-Q model"
)
